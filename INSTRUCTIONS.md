...
This is a work-in-progress set of instructions for creating a tutorial on using PShader in Processing. The goal is to cover the basics of shaders, how they work in Processing, and a general introduction to both fragment and vertex shaders for beginners who want to learn how to use shaders effectively in Processing.

## Resources

- We are writing the actual WIP tutorial in PShader_Tutorial.md
